...
abbr[data-original-title] {
  cursor: help;
  border-bottom: 1px dotted #969896;
}
.initialism {
  font-size: 90%;
  text-transform: uppercase;
...
.table > thead > tr > th {
  ...
  border-bottom: 2px solid #c5c8c6;
}
...
.nav-tabs > li > a:hover {
  border-color: #373b41 #373b41 #dddddd;
}
